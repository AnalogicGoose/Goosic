...
const CARD_CLASS =
  "squircle-cover-hover group flex w-full flex-col gap-2 rounded-lg p-3 text-left transition-colors hover:bg-accent/60 focus-visible:bg-accent focus-visible:outline-none";
